...
/**
 * The Class KafkaGenericRecordDecoder. A wrapper for a GenericRecordDecoder which will allow Kafka to use the decoder internally as a deserializer
 ...
 */
public class KafkaGenericRecordDecoder implements Decoder<GenericRecord>, Deserializer<GenericRecord> {

    protected static final Logger LOGGER = LoggerFactory.getLogger(KafkaGenericRecordDecoder.class);
     ...
     */
    public KafkaGenericRecordDecoder() {
     ...
     *            the props
     */
    public KafkaGenericRecordDecoder(final VerifiableProperties props) {
        this();
    }
     ...
     *            the decoder
     */
    public KafkaGenericRecordDecoder(final GenericRecordDecoder decoder) {
